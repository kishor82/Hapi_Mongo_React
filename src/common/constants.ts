...
export const API_ROUTE_GET_PRODUCTS = `${API_ROUTE}/products`;
export const API_ROUTE_LOGIN = `${API_ROUTE}/login`;
export const API_ROUTE_USER_PROFILE = `${API_ROUTE}/users/profile`;
export const API_ROUTE_REGISTER = `${API_ROUTE}/register`;
export const API_ROUTE_ADD_ORDER_ITEMS = `${API_ROUTE}/orders`;
